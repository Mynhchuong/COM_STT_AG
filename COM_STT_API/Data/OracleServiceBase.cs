...
public abstract class OracleServiceBase
{
    ...
    protected OracleServiceBase(IConfiguration configuration, string connectionStringName)
    {
        _connStr = configuration.GetConnectionString(connectionStringName)
    ...
    // Dùng khi cần nhiều lệnh chạy chung 1 connection/transaction thật.
